                          ...
                          DataCell(
                            constraints.maxWidth < 600
                                ? Wrap(
                                    spacing: 8,
                                    children: [
                                      _buildActionButton(context, usuario.id!, 'Aceptar', Icons.check, Colors.green, true),
                                      _buildActionButton(context, usuario.id!, 'Rechazar', Icons.cancel, Colors.red, false),
                                    ],
                                  )
                                : Row(
                                    children: [
