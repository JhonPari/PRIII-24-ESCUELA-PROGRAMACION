...
class CalificarPruebaAdmin extends StatefulWidget {
  ...
  @override
  CalificarPruebaAdminState createState() => CalificarPruebaAdminState();
}

class CalificarPruebaAdminState extends State<CalificarPruebaAdmin> {
